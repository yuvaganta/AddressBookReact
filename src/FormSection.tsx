  ...
  function submitHandler(e:any){
    ...
    if(statesObj.formAction=="add"){
     ...
     navigate("/details/"+statesObj.selectedContactId);
      ...
      let newContact:IContact;
      newContact={id:statesObj.selectedContactId,name:formFields.name,email:formFields.email,mobile:formFields.mobile,address:formFields.address,website:formFields.website,landline:formFields.landline}
...
return(
    ...
    { validates.isEmailValidate && <div className="warnings" id="emailWarning"> Enter Valid Email Id</div>}
          ...
          <div>
    <input type="text" id="addMobile" name="mobile" value={formFields.mobile}onChange={handleChange}/>
    <input
              type="text"
              id="addLandline"
              name="landline"
          ...
          <div>
    <input type="text" className="inbox" name="website" id="addWebsite" value={formFields.website} onChange={handleChange}/></div>
